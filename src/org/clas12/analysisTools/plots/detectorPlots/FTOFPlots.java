...
public class FTOFPlots implements DetectorPlots {
	...
	public FTOFPlots(WithoutCanvas canvas, String name){
		this.canvas = null;
	...
	public void createHistogramsWithoutCanvas(WithoutCanvas canvas) {
		canvas.create2DHisto(detectorName+"BetavsP", detectorName+"Beta vs P", "Tphot", "Telec", 100, 0, 10, 100, 0, 1);
		canvas.create2DHisto(detectorName+"BetavsP-elec", detectorName+"Beta vs P Elec", "Tphot", "Telec", 100, 0, 10, 100, 0, 1);
		canvas.create2DHisto(detectorName+"BetavsP-prot", detectorName+"Beta vs P prot", "Tphot", "Tprot", 100, 0, 10, 100, 0, 1);
...
//			}
	...
	public void fillHistogramWithoutCanvas(Event event) {
		...
		for (Particle particle : particleEvent.getParticles()){
			this.myCanvas.fill2DHisto(detectorName+"BetavsP", particle.getP(), particle.getBeta());
		}
...
//				System.out.println("elec nb ftof hits: "+particle.hasFTOFClusters());
//			}
			this.myCanvas.fill2DHisto(detectorName+"BetavsP-elec", particle.getP(), particle.getBeta());
...
//							System.out.println("time: "+ particle2.getFTOFClusters().get(i).getTime());
//							System.out.println("time: "+ particle.getFTOFClusters().get(j).getTime());
							this.myCanvas.fill2DHisto(detectorName+"TelecvsTprot", particle2.getFTOFClusters().get(i).getTime(), particle.getFTOFClusters().get(j).getTime());
						}
					}
				}
			}
...
//				System.out.println("prot nb ftof hits: "+particle.hasFTOFClusters());
//			}
			this.myCanvas.fill2DHisto(detectorName+"BetavsP-prot", particle.getP(), particle.getBeta());
		}
